...
_APP_ENV = [
    ...
    "MCP_ALLOWED_HOSTS",
    # third-party telemetry switches the engine guards / pins
    "ALLOW_LANGSMITH_TRACING", "LANGSMITH_TRACING", "LANGCHAIN_TRACING_V2", "LANGCHAIN_TRACING",
    "LITELLM_LOCAL_MODEL_COST_MAP", "MLFLOW_DISABLE_TELEMETRY", "DO_NOT_TRACK",
]
